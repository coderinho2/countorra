    ...
    articles: [
      {
        ...
        body: [
          "Countorra is a financial workspace. You keep your accounts, income and expenses in it — and, if you work for yourself or run a business, your customers and invoices — and Countorra turns those records into an overview, reports, insights and tax preparation.",
      ...
      {
        id: "choosing-a-workspace-type",
        title: "Choosing Personal, Freelancer or Business",
        summary: "The first onboarding step decides which tools your workspace shows.",
        body: [
          "After you confirm your email, Countorra asks what you are using it for. Each answer creates a workspace of that type:",
        ],
        points: [
          "Personal — for managing your own money. Includes the Overview, transactions, accounts, bank connections, documents, insights, tax preparation and Ask Countorra.",
          "Freelancer — for income, expenses and taxes from independent work. Adds invoices, customers and reports.",
          "Business — for a company's finances. The same tools as Freelancer.",
        ],
        keywords: ["entity", "entity type", "personal", "freelancer", "business", "self-employed", "onboarding", "workspace type"],
      },
      {
        ...
        body: [
          "The second onboarding step names the workspace. After that, a useful order is:",
        ],
        points: [
          ...
          "Set your country and state in Settings → Organization. Tax preparation reads the state from here every time it calculates.",
        ],
        where: "Accounts · Settings → Organization · Settings → Categories",
      ...
      },
      {
        ...
        body: [
          "A workspace holds one person's or one business's finances. Its data is never visible from another workspace, and each has its own members and its own plan.",
        ...
        keywords: ["organization", "organisations", "multiple", "switch", "second business", "new workspace"],
      },
      {
        id: "the-overview",
    ...
    articles: [
      {
        ...
        body: [
          ...
          "It can also propose changes: categorising a transaction, recording a transaction or expense, drafting an invoice, or suggesting a tax figure. None of these happens until someone with permission confirms it. It cannot delete anything, send invoices, connect banks or move money.",
      ...
      },
      {
        ...
        body: [
          ...
          "Totals are shown on the Overview, in Reports for freelancer and business workspaces, and by Ask Countorra, which can total income or expenses for any date range and compare one period with another. Figures are on a cash basis: they count transactions when they happen.",
        ],
      ...
      },
      {
        id: "invoices",
        title: "Invoices",
        summary: "Create, send and track invoices. Freelancer and Business workspaces.",
        body: [
          "Create an invoice for a customer with its line items; it starts as a draft. Sending it emails the customer a PDF and a private link to view it online.",
          "Sending an invoice that has already gone out sends a reminder instead, or an overdue notice once the due date has passed. Invoices move between draft, sent, paid, overdue and void — and only in ways that make sense, so a paid invoice cannot become a draft again.",
        ],
        where: "Invoices",
        keywords: ["invoice", "billing clients", "send invoice", "reminder", "overdue", "paid", "pdf"],
      },
      {
        id: "customers",
        title: "Customers",
        summary: "Who you invoice, and what each of them still owes. Freelancer and Business workspaces.",
        body: [
          "A customer is someone you invoice. Each customer's page shows their invoices and what they still owe you. Add a customer before creating their first invoice.",
        ],
        where: "Customers",
        keywords: ["client", "clients", "customer", "owed", "receivables"],
      },
      {
        id: "reports",
        title: "Reports",
        summary: "An income statement for any period, plus the invoices issued in it. Freelancer and Business workspaces.",
        body: [
          "Reports show a statement for the date range you choose: income, then expenses by category, then the net result — alongside the invoices issued in that period.",
          "Ask Countorra can prepare the same profit and loss view, and compare one period with another.",
        ],
        where: "Reports",
        keywords: ["report", "profit and loss", "p&l", "statement", "income statement", "financial reports"],
      },
      {
        id: "insights",
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        body: [
          "Income, expenses, profit and margin are calculated from the transactions in your workspace on a cash basis. Sales tax and VAT are not looked up: the assistant can apply a rate you give it, but that arithmetic is not the tax owed, and it drafts invoices without tax.",
        ],
    ...
    articles: [
      ...
      },
      {
        ...
        points: [
          ...
          "Organization — the workspace's name, country, state and currency.",
...
export const HELP_FAQS: HelpFaq[] = [
  {
    ...
    answer: [
      "Countorra is a financial workspace with an AI assistant built in. You keep your accounts, income and expenses in it — and, for freelancers and businesses, customers and invoices — and Countorra turns them into an overview of where you stand, reports, insights about your spending, and tax preparation.",
  ...
  },
  {
    ...
    answer: [
      ...
      "It can also propose changes — categorising a transaction, recording one, drafting an invoice — but none of them happens until someone with permission confirms it. Its figures are calculated by Countorra's calculation engine, not made up by the AI.",
  ...
  },
  {
    ...
    points: [
      "Answers come from your records. The assistant works from the transactions, invoices and documents in your workspace — not from general knowledge about money.",
      ...
      "One set of records. The ledger, invoices, documents, reports and tax preparation all read from the same data, so there is nothing to copy between tools.",
    ],
  ...
  },
  {
    ...
    answer: [
      "If your finances are spread across bank apps, spreadsheets and a folder of receipts, Countorra puts the records in one place and lets you ask questions of them directly — “what did I spend on software last quarter?”, “which invoices are overdue?” — and get an answer calculated from your own data.",
  ...
  },
  {
    ...
    points: [
      ...
      "Choose Personal, Freelancer or Business, and name your workspace.",
      "Add your accounts, then record transactions — or, on Premium and Business, connect a bank through Plaid to import them.",
      "Read the Overview, Insights and, for freelancers and businesses, Reports.",
      "Ask Countorra questions, and confirm any change it proposes.",
      "Freelancers and businesses can invoice customers; anyone can prepare a supported US tax year.",
    ],
  ...
  },
  {
    ...
    answer: [
      "Both. Each workspace is Personal, Freelancer or Business. Personal workspaces focus on spending, recurring costs, financial health and tax preparation. Freelancer and Business workspaces add invoices, customers and reports.",
      "You can have more than one workspace — for example your personal finances and your business — up to your plan's limit. Each keeps its data separate and has its own plan.",
    ],
  ...
  },
  {
    ...
    points: [
      ...
      "List invoices, overdue invoices and customers.",
      ...
      "Propose changes — categorise a transaction, record a transaction or expense, draft an invoice, suggest a tax figure — each of which waits for confirmation.",
    ],
