      ...
      visual={
        <div className="overflow-hidden rounded-md border border-border-subtle bg-surface">
          ...
          <div className="flex flex-col gap-5 p-6 sm:p-8">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-5 border-t border-border-subtle pt-5 sm:grid-cols-3 sm:gap-x-0 sm:divide-x sm:divide-border-subtle">
          ...
          <div className="border-t border-border-subtle p-6 sm:p-8">
